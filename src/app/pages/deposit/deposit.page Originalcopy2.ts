    ...
    // if(this.validateData() && !this.form.valid){
      ...
      async (response) => {
        ...
        if (response.status === 'processing') {
          this.presentDepositStatusModal('Processing', formData.amount)
        } else if (response.status === 'success') {
          this.presentDepositStatusModal('Success', formData.amount);
        } else if (response.status === 'error') {
          this.presentDepositStatusModal('Error', formData.amount);
        }
