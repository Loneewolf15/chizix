...
resendDisabled: boolean = false;
  ...
  matchValues(pin2: any, confirm_pin2: any) {
  ...
  initForm() {
    this.form = new FormGroup({
      pin: new FormControl(null, { validators: [Validators.required, Validators.minLength(4)] }),
      confirm_pin2: new FormControl(null, {
  ...
  matchingPasswords(control: any) {
    if (this.form) {
      if (control.value !== this.form.controls['confirm_pin2'].value) {
