...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () => import('./pages/tabs/profiles/accounts/verification/verification.page').then( m => m.VerificationPage)
  },
  {
    path: 'verification/scan',
    loadComponent: () => import('./pages/tabs/profiles/accounts/verification/scan/scan.page').then( m => m.ScanPage)
  },
  {
    path: 'verification/selfie',
    loadComponent: () => import('./pages/tabs/profiles/accounts/verification/selfie/selfie.page').then( m => m.SelfiePage)
  },
  {
    path: 'profiles/help',
  ...
  // },
  {
    ...
    loadComponent: () => import('./pages/tabs/receives/receivesub/receivesub.page').then( m => m.ReceivesubPage)
  },
  {
    path: 'intro',
  ...
  {
    path: 'withdrawal',
    loadComponent: () => import('./pages/withdrawal/withdrawal.page').then( m => m.WithdrawalPage)
  },
  {
    path: 'send',
  ...
  {
    path: 'subaccount',
    loadComponent: () => import('./pages/subaccount/subaccount.page').then( m => m.SubaccountPage)
  },
  {
    path: 'change-pin',
